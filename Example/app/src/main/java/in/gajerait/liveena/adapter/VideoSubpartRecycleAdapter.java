...
public class VideoSubpartRecycleAdapter extends RecyclerView.Adapter<VideoSubpartRecycleAdapter.AvailViewHolder> {
    ...
    public VideoSubpartRecycleAdapter(Context context, ArrayList<BeanGallery> vouchers, String type) {
    ...
    public void onBindViewHolder(AvailViewHolder holder, final int position) {
        ...
        holder.llGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] temp = vouchers.get(position).getyou().split("\\/");
