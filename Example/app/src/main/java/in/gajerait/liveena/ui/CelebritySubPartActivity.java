...
public class CelebritySubPartActivity extends AppCompatActivity implements ViewPagerEx.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = CelebritySubPartActivity.this;
...
//        video_recycleView.setLayoutManager(new LinearLayoutManager(activity));
    ...
    public void CelebritySubPart() {
        ...
        StringRequest sReq = new StringRequest(Request.Method.POST, "http://liveena.com/celebrity_category_part_api.php",
