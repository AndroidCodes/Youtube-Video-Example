...
import in.gajerait.liveena.adapter.VideoCategoryAdapter;
...
public class VideoCategory extends AppCompatActivity implements ViewPagerEx.OnPageChangeListener {
    ArrayList<BeanPhotoCategory> AvailVoucher;
    private Activity activity;
    private RecyclerView VideoCategory_recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHeader.setText(R.string.Videocategory);
        ...
        VideoCategory_recyclerView = (RecyclerView) findViewById(R.id.VideoCategory_recyclerView);
        VideoCategory_recyclerView.setLayoutManager(new GridLayoutManager(activity, 2));
//        VideoCategory_recyclerView.setLayoutManager(new LinearLayoutManager(activity));
...
//                               [{"logo":"http:\/\/support.peacocktech.in:8081\/lid\/siteuploads\/company_logo_image\/1466657972_download.jpg","company_id":"84","terms_condition":"Lorem Ipsum is
    ...
    private void VideoCategory() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://liveena.com/video_category_api.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            System.out.println("liveena-->> " + response.toString());
                            ...
                            if (success == 1) {
                                ...
                                if (jaDetail.length() > 0) {
                                    ...
                                    VideoCategory_recyclerView.setVisibility(View.VISIBLE);
                                    adapter = new VideoCategoryAdapter(activity, AvailVoucher, "avail");
                                    VideoCategory_recyclerView.setAdapter(adapter);
                                    pDialog.dismiss();
                                } else {
                                    pDialog.dismiss();
                                    CommonUtility.showAlertDialog(activity, getResources().getString(R.string.No_Internet), getResources().getString(R.string.app_name), true);
