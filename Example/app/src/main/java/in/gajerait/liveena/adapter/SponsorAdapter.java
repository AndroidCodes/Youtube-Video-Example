...
import in.gajerait.liveena.ui.SponsorCategoryActivity;
import me.zhanghai.android.materialprogressbar.MaterialProgressBar;

public class SponsorAdapter extends RecyclerView.Adapter<SponsorAdapter.AvailViewHolder> {
    ...
    public SponsorAdapter(Context context, ArrayList<BeanPhotoCategory> vouchers, String type) {
        ...
        holder.llPCitem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (NAME.equals("")){
                    ...
                    Intent intent = new Intent(context, SponsorCategoryActivity.class);
