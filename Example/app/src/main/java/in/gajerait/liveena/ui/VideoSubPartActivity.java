...
import in.gajerait.liveena.adapter.VideoSubpartRecycleAdapter;
...
public class VideoSubPartActivity extends AppCompatActivity implements ViewPagerEx.OnPageChangeListener {
    ...
    private VideoSubpartRecycleAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = VideoSubPartActivity.this;
...
//        video_recycleView.setLayoutManager(new LinearLayoutManager(activity));
    ...
    public void VideoSubPartActivity() {
        ...
        StringRequest sReq = new StringRequest(Request.Method.POST, "http://liveena.com/video_category_part_api.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            System.out.println("VideoSubPartActivity.." + response);
                            ...
                            if (success == 1) {
                                ...
                                if (jaDetail.length() > 0) {
                                    ...
                                    tvHeader.setText(NAME + " (" + jaDetail.length() + " video)");
                                    noData.setVisibility(View.GONE);
                                    video_recycleView.setVisibility(View.VISIBLE);

                                    adapter = new VideoSubpartRecycleAdapter(activity, AvailVoucher, "avail");
