...
public class PhotoCategoryAdapter extends RecyclerView.Adapter<PhotoCategoryAdapter.AvailViewHolder> {
    ...
    public PhotoCategoryAdapter(Context context, ArrayList<BeanPhotoCategory> vouchers, String type) {
