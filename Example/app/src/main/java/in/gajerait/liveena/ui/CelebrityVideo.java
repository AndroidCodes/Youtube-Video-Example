...
import in.gajerait.liveena.adapter.CelebrityVideoAdapter;
...
public class CelebrityVideo extends AppCompatActivity implements ViewPagerEx.OnPageChangeListener{
    ArrayList<BeanGallery> AvailVoucher;
    private Activity activity;
    private RecyclerView CelebrityVideo_recyclerView;
    private TextView noData, txtTitle, tvHeader;
    private KProgressHUD pDialog;
    private CelebrityVideoAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHeader.setText(R.string.CelebrityVideo);
        ...
        CelebrityVideo_recyclerView = (RecyclerView) findViewById(R.id.CelebrityVideo_recyclerView);
//        CelebrityVideo_recyclerView.setLayoutManager(new GridLayoutManager(activity, 2));
        CelebrityVideo_recyclerView.setLayoutManager(new LinearLayoutManager(activity));
    ...
    private void CelebrityVideo() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://liveena.com/celebrity_video_category_api.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            System.out.println("celebrity_video_category-->> " + response.toString());
                                ...
                                if (jaDetail.length() > 0) {
                                    ...
                                    for (int i = 0; i < jaDetail.length(); i++) {
                                        ...
                                        AvailVoucher.add(new BeanGallery(joDetail.optString("id"), joDetail.optString("category"),
                                                ...
                                                joDetail.optString("you")));

                                    }

                                    noData.setVisibility(View.GONE);
                                    CelebrityVideo_recyclerView.setVisibility(View.VISIBLE);
                                    adapter = new CelebrityVideoAdapter(activity, AvailVoucher, "avail");
                                    CelebrityVideo_recyclerView.setAdapter(adapter);
                                } else {
